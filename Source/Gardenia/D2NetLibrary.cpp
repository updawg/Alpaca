...
{
	return (TD2SendToServer)GetOffsetByProc(10005, 10005, 10005, 10035, 10020, 10036, 10024, 10015);
}

D2NetLibrary::TD2SendToClient D2NetLibrary::GetD2SendToClient()
{
	return (TD2SendToClient)GetOffsetByProc(10006, 10006, 10006, 10018, 10018, 10015, 10002, 10012);
}