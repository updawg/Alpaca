...
void Fog::SetFunctions()
{
	...
	D2FogMemAlloc = (TD2FogMemAlloc)GetOffsetByProc(10042, 10042);
	D2FogMemDeAlloc = (TD2FogMemDeAlloc)GetOffsetByProc(10043, 10043);
	D2AllocMem = (TD2AllocMem)GetOffsetByProc(10045, 10045);
	D2FreeMem = (TD2FreeMem)GetOffsetByProc(10046, 10046);
	D2MPQOpenFile = (TD2MPQOpenFile)GetOffsetByProc(10102, 10102);
	D2MPQCloseFile = (TD2MPQCloseFile)GetOffsetByProc(10103, 10103);
	D2MPQReadFile = (TD2MPQReadFile)GetOffsetByProc(10104, 10104);
	D2MPQGetSizeFile = (TD2MPQGetSizeFile)GetOffsetByProc(10105, 10105);
	D2FogGetSavePath = (TD2FogGetSavePath)GetOffsetByProc(10115, 10115);
	D2FogGetInstallPath = (TD2FogGetInstallPath)GetOffsetByProc(10116, 10116);
