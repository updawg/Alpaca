...
void Install_InterfaceStash()
{
	...
	Memory::ChangeCallC((DWORD)D2Client::D2ClickOnStashButton, (DWORD)caller_manageBtnDown);

	// Manage mouse up (Play sound)
	Memory::SetCursor(MouseUpSoundOffset);
	Memory::ChangeCallC((DWORD)D2Client::D2ClickOnStashButton, (DWORD)caller_manageBtnUp);
