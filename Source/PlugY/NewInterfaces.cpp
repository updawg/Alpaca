...
void Install_NewInterfaces()
{
	...
	MEMT_REF4( 0x00008088, lu->D2Client->DllVersion >= VersionUtility::Versions::V111 ? caller_mouseCustomPageLeftDown_111 : version_D2Client == VersionUtility::Versions::V110 ? caller_mouseCustomPageLeftDown : caller_mouseCustomPageLeftDown_9);
	...
	MEMT_REF4( ptWindowStartX, lu->D2Client->DllVersion >= VersionUtility::Versions::V111 ? caller_mouseCustomPageLeftUp_111 : version_D2Client == VersionUtility::Versions::V110 ? caller_mouseCustomPageLeftUp : caller_mouseCustomPageLeftUp_9);
